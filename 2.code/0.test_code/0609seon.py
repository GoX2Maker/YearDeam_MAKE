...
def input_pre2(csvPath, imgPath, moveTxt, txtFont = "AppleGothic.ttf", txtSize = 15):
    """prescription2 정보처리
...
# csvPath = r'1.data\3.DB\prescription2.csv'
...
text_dict, result_img = input_pre2(csvPath, imgPath, moveTxt)
print(text_dict)
